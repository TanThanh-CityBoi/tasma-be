...
let AuthService = class AuthService {
    ...
    async login(userLogin) {
        ...
        const validPassword = !!userFind && (await bcryptjs_1.default.compare(loginPassword, userFind.password));
    ...
    async changePassword(userLogin, currentClearTextPassword, newPassword) {
        ...
        if (!(await bcryptjs_1.default.compare(currentClearTextPassword, userFind.password))) {
    ...
    async registerNewUser(newUser) {
        ...
        const user = await this.userService.save(Object.assign(Object.assign({}, newUser), { activated: true }), newUser.login, true);
        return user;
    }
